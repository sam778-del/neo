                    ...
                    <ais-hits>
                        <div slot-scope="{ items }">
                            ...
                            <template v-if="currentItemView == 'item-grid-view'">
                                <vs-row class="items-grid-view match-height">
                                    <vs-col vs-xs="12" vs-sm="6" vs-lg="6" v-for="item in items" :key="item.objectID">
                                        ...
                                        <item-grid-view :item="item">
                                            ...
                                            <template slot="action-buttons">
                                                <div class="">
                                                    ...
                                                    <div
                                                        class="text-center mb-6  text-white cursor-pointer"
                                                        @click="cartButtonClicked(item)">
                                                     
                                                         <vs-button> 
                                                        <span v-if="isInCart(item.objectID)">VIEW IN CART</span>
                                                        <span  v-else>ADD TO CART</span>
                                                         </vs-button>

                                                        <!-- <vs-button  color="primary" type="border" >Add To Cart</vs-button> -->
                                                    </div>
                                                </div>
                                            </template>
                                        </item-grid-view>
