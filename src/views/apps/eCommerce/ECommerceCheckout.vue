    ...
    <div id="ecommerce-checkout-demo">
        <form-wizard
            ...
            <tab-content title="Cart" icon="feather icon-shopping-cart" class="mb-5">
                ...
                <!-- IF CART HAVE ITEMS -->
                <vs-row v-if="cartItems.length">
                

                    <!-- LEFT COL -->
                    <vs-col vs-xs="12" vs-sm="6" vs-lg="6" class=" w-full relative">
                    ...
                    <!-- RIGHT COL -->
                     ...
                     <vs-col vs-xs="12" vs-sm="4" vs-lg="4" class="w-full">
                        <vs-card>
            ...
            <tab-content title="Payment" icon="feather icon-credit-card" class="mb-5">
               ...
               <vs-row>
                   ...
                   <vs-col vs-xs="12" vs-sm="3" vs-lg="3">
                        <vs-card subtitle="Be sure to click on correct payment option">
                             <div slot="header">
                              <h3>
                                 Payment Options
                              </h3>
