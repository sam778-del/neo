    ...
    <div>
        <vs-sidebar click-not-close parent="#email-app" :hidden-background="true" class="full-vs-sidebar email-view-sidebar" v-model="isSidebarActive" position-right>
            <div class="mail-sidebar-content px-0 sm:py-6 pt-2 h-full" v-if="currentMail">
                ...
                <vs-row v-if="currentMail.replies.length && !showThread">
                    <vs-col class="w-full">
                ...
                <div v-if="isSidebarActive">
                    ...
                    <!-- ALL MESSAGES - THREAD -->
                    <vs-row v-for="threadMail in currentMail.replies.slice().reverse()" :key="threadMail.id" v-if="showThread">
                        <vs-col class="w-full">
                            <vs-card class="px-4 mb-10">

                                <!-- MAIL META ROW -->
                                <vs-row>
                                    <vs-col class="w-full border-b border-l-0 border-r-0 border-t-0 border-grey-light border-solid flex justify-between flex items-center">
                                        <div class="flex items-center">
                                            <div>
                                ...
                                <!-- MAIL ATTACHMENTS -->
                                <vs-row v-if="threadMail.attachments.length">
                                    <vs-col class="w-full border-b border-l-0 border-r-0 border-t-0 border-grey-light border-solid mb-6 flex">
                    ...
                    <vs-row>
                        <vs-col class="w-full">
                            <vs-card class="px-4">
                                ...
                                <!-- MAIL META ROW -->
                                <vs-row class="w-full border-b border-l-0 border-r-0 border-t-0 border-grey-light border-solid flex justify-between flex items-center">
                                    <vs-col vs-xs="12" vs-sm="6" vs-lg="6" class="vx-col sm:w-4/5 w-full flex flex-wrap items-center mb-2">
                                    ...
                                    <vs-col vs-xs="12" vs-sm="6" vs-lg="6" class="flex items-center mb-2">
                                ...
                                <!-- MAIL ATTACHMENTS -->
                                <vs-row v-if="currentMail.attachments.length">
                                    <vs-col vs-xs="12" vs-sm="6" vs-lg="6" class="w-full border-b border-l-0 border-r-0 border-t-0 border-grey-light border-solid mb-6 flex">
                                        <feather-icon icon="PaperclipIcon"></feather-icon>
                                        <span class="block py-4">ATTACHMENTS</span>
                                    </vs-col>
                                    <div class="flex">
                    ...
                    <vs-row style="margin-top: 2.2rem">
                        <div class="w-full pb-10">
                            <vs-card>
                                <vs-row>
                                    <vs-col class="w-full flex justify-between">
