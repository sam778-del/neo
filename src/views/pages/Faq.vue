...
<template>
    <div id="faq-page">
        ...
        <div class="faq-jumbotron">
            ...
            <div class="faq-jumbotron-content p-8 rounded-lg mb-base">
                <h1 class="mb-1 text-white">Frquenty Asked Questions</h1>
                <vs-row class="w-full">
              <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-xs="12" vs-sm="10" vs-md="8" vs-lg="5" class="mx-auto">
            ...
            <vs-row class="w-full">
              <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-w="10" class="mx-auto">
              <vs-card class="faq-banner">
                    <ul class="faq-topics text-center">
                        <li v-for="category in categories" :key="category.id" class="" @click="faqFilter = category.id">
      ...
      <vs-row>
            ...
            <!-- FAQ COL -->
            <vs-col vs-xs="12" vs-sm="10" vs-md="8" vs-lg="10" class="mx-auto">
