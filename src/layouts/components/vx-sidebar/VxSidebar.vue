  ...
  <div class="parentx">
    ...
    >
      <div @mouseenter="sidebarMouseEntered" @mouseleave="sidebarMouseLeave">
        <div class="header-sidebar flex items-center justify-between" slot="header">
          ...
          <div class="bars-button">
            ...
            <template v-else-if="!showCloseButton && !sidebarItemsMin">
              <button id="btnSidebarToggler" v-show="!reduce" @click="toggleReduce(true)">
                <i class="fas fa-bars fa-lg"></i>
              </button>
              <button v-show="reduce" @click="toggleReduce(false)" id="btnSidebarToggler">
                <i class="fas fa-bars fa-lg"></i>
              </button>
            </template>
          </div>
        ...
        <div class="sidebar-profile py-5 px-4">
          <div class="flex items-center">
            <div class="mr-4">
              <img src="@/assets/images/sidebar-profile.jpg" alt="logo" width="60">
            </div>
            <div>
              <h5 class="mt-0 mb-1 sidebar-profile-name">John Doe</h5>
